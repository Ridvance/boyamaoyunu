...
- Bu dosyadaki fikirler otomatik uygulanmaz.
- Kullanıcı onayı olmadan `CURRENT_PHASE.md` içine taşınmaz.
- Onaylanan fikirler `PHASES.md` içinde küçük fazlara bölünür.
- Her uygulanabilir faz için `PROMPTS/phase-*.md` yazılır.
...
- Etki: Aile güveni ve gerçek kullanım sinyali üretir.
- Durum: onay bekliyor.

### Uygulama içinden talep toplama
- Kaynak: 2026-05-19 kullanıcı konuşması.
- Niyet: Ebeveynlerden "nasıl oyun olsa iyi olurdu?" geri bildirimi almak.
- Etki: Ürün fikirlerini gerçek kullanıcıdan besler.
- Durum: onay bekliyor.

### Düzenli yeni boyama paketleri
- Kaynak: 2026-05-19 kullanıcı konuşması.
- Niyet: Uygulamanın aynı kalmamasını sağlamak.
- Etki: Sıkılma döngüsünü azaltır ve ücret algısını güçlendirir.
- Durum: onay bekliyor.

## Orta Vade Adayları

### Fotoğrafı çizime dönüştürme
- Kaynak: 2026-05-19 kullanıcı konuşması.
...
### İngilizce versiyon
- Kaynak: 2026-05-19 kullanıcı konuşması.
- Niyet: Global pazara açılmak.
- Etki: Satın alma potansiyelini artırır.
- Durum: temel ürün doğrulandıktan sonra.

## Uzak Vade / Rüya

### Ücretli paket veya abonelik
- Kaynak: 2026-05-19 kullanıcı konuşması.
- Niyet: Ailenin faydalı gördüğü ürün için ödeme yapması.
- Etki: Gelir modeli oluşur.
- Durum: kullanıcı güveni ve ürün değeri kanıtlandıktan sonra.
