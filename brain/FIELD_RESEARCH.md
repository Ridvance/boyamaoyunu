...
4-5 yaş çocuk oyunu için iyi mekanik tek başına yetmez. Uygulama adı, ana karakter, renk dünyası ve ilk ekran çocuğu çekmezse ürün kaybedebilir. Bu kararlar yalnızca AI önerisi veya internet genellemesiyle kesinleştirilmez; gerçek çocuk ve ebeveyn gözlemiyle doğrulanır.

## Neden Saha Gerekli

- İnternette 4-5 yaş çocukların güncel tercihleri için güvenilir ve yerel veri zayıf olabilir.
- Yakın çevredeki ebeveyn, anaokulu bağlantısı veya çocuk gözlemi daha güncel sinyal verir.
- Çocukların sempatik bulduğu karakter ile yetişkinin güzel bulduğu karakter farklı olabilir.
- İsim tek başına ürünü güçlendirebilir veya zayıflatabilir.

## İlk Doğrulama Soruları

- 4-5 yaş çocuklar hangi karaktere kendiliğinden yaklaşıyor?
- Hangi karakteri "sevimli" veya "oynanabilir" buluyorlar?
- 4-5 isim seçeneğinden hangisini karaktere yakıştırıyorlar?
- Ebeveyn hangi tasarımı güvenilir ve rahatsız etmeyen buluyor?
- Çocuk ilk ekranda neye basmak istiyor?

## Basit Test Planı

1. 4-5 farklı karakter yönü hazırla.
2. Her karakter için 4-5 kısa isim seçeneği hazırla.
3. Çocuğa tek tek açıklama yapmadan göster; ilk baktığı, dokunduğu veya seçtiği seçeneği not al.
4. "Bunun adı ne olsun?" veya "Bu isimlerden hangisi buna yakışır?" gibi kısa sorular sor.
5. Ebeveynden güven, rahatsız edicilik ve ücret ödeme isteği açısından kısa yorum al.
6. En az 3 çocuk veya çocuk gözlemi tamamlanmadan ana karakter/ad kesinleştirme.

## İlk Aday Tema Hipotezleri

- Sevimli kedi karakteri.
- Yumuşak çizgili hayvan dostu.
- Boyama yapan küçük maskot.
- Şekil/renk dostları.
- Çocuğun kendi dünyasına yakın nesne karakterleri.
...
- Çocuk yaşı:
- Gösterilen karakter seçenekleri:
- İlk seçtiği karakter:
