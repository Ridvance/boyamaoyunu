...
void main() {
  ...
  testWidgets('dashboard shows persisted progress for each game', (
    ...
    expect(
      find.byKey(const ValueKey('game-progress-coloring')),
      findsOneWidget,
    );
  ...
  testWidgets(
    'parent controls persist preferences and confirm progress reset',
    (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({
        'journey_completed_coloring': ['0'],
        'journey_stars_coloring_0': 3,
      ...
      await tester.tap(
        find.byKey(const ValueKey('parent-gate-option-correct')),
      );
      await tester.pumpAndSettle();

      expect(
        find.byKey(const ValueKey('parent-progress-summary')),
        findsOneWidget,
      );
  ...
  testWidgets('habits game completes eight tasks across four categories', (
    ...
    for (final taskId in taskIds) {
      expect(find.byKey(ValueKey('habit-progress-$taskId')), findsOneWidget);
  ...
  testWidgets(
    'learning packs exposes three packs and completes an inline activity',
    (WidgetTester tester) async {
      SharedPreferences.setMockInitialValues({});
      await ProgressService.instance.init();
      await AppSettingsService.instance.init();
      ...
      expect(
        find.byKey(const ValueKey('learning-pack-first-skills')),
        findsOneWidget,
      );
      expect(
        find.byKey(const ValueKey('learning-pack-colors-shapes')),
        findsOneWidget,
      );
      expect(
        find.byKey(const ValueKey('learning-pack-daily-heroes')),
        findsOneWidget,
      );
      ...
      await tester.pump();
      expect(
        find.byKey(const ValueKey('learning-activity-color-mix-practice')),
        findsOneWidget,
      );
      expect(
        find.byKey(const ValueKey('learning-activity-color-sequence')),
        findsOneWidget,
      );
      expect(
        find.byKey(const ValueKey('learning-activity-shape-path')),
        findsOneWidget,
      );
  ...
  testWidgets(
    'coloring game inactivity triggers GhostHandHint and interaction hides it',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'magic colors sandbox mode triggers guidance hand pointing to red tube then mix button',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'ChameleonPainter renders expressions neutral, happy, surprised without error',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'tracing game inactivity triggers GhostHandHint and interaction hides it',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'balloon pop game inactivity triggers GhostHandHint on active balloon',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'shape sorter game inactivity triggers GhostHandHint and PulseTarget, and interaction hides it',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'shape sorter game drag cancel triggers Kamo surprised expression and wiggle feedback',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      final gesture = await tester.startGesture(
        tester.getCenter(draggableFinder.first),
      );
  ...
  testWidgets(
    'shape sorter game correct drop updates score and advances level',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      for (int i = 0; i < 4; i++) {
        ...
        final matchingRight = rightItems.firstWhere(
          (item) => item.type == unplacedLeft.type,
        );
  ...
  testWidgets(
    'sound board game inactivity triggers GhostHandHint and PulseTarget, and interaction hides it',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'sound board game key and animal tap triggers Kamo happy expression',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'habits game inactivity triggers GhostHandHint on active button',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'habits game tapping completed task triggers Kamo surprised expression and soft wrong feedback',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'habits game all tasks complete triggers temporary celebration effect and permanent Kamo happy',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets(
    'learning packs inactivity triggers GhostHandHint on first pack and then first activity',
    (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      await tester.tap(
        find.byKey(const ValueKey('learning-packs-back-button')),
      );
      await tester.pump();
  ...
  testWidgets(
    'magic colors works in compact landscape layout height < 400 without overflow',
    (WidgetTester tester) async {
